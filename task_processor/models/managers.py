...
class GTDQuerySet(models.QuerySet):
    ...
    def active(self):
        ...
        return self.exclude(status__in=[GTDStatus.COMPLETED, GTDStatus.CANCELLED, GTDStatus.REFERENCE])
...
class ItemManager(models.Manager):
    ...
    def high_priority(self, user):
        ...
        return self.for_user(user).filter(
            priority__in=[Priority.HIGH, Priority.URGENT],
            is_completed=False
        ).active()
